// Tremor Raw chartColors [v0.1.0] + getYAxisDomain [v0.0.0]
// Sourced verbatim from https://github.com/tremorlabs/tremor
// (src/utils/chartColors.ts, src/utils/getYAxisDomain.ts) -- these are
// small, dependency-free utilities the BarChart component below needs;
// copied rather than reimplemented so BarChart.tsx's own source (also
// copied verbatim) doesn't have to be modified to match a different API.
