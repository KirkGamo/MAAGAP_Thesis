...
// https://raw.githubusercontent.com/tremorlabs/tremor/main/src/components/BarChart/BarChart.tsx
// (Tremor Raw). Only import paths were adjusted to this project's file
// layout (chart-utils.ts / use-on-window-resize.ts / lib/utils.ts's `cn`
// aliased as `cx`) -- component logic is untouched.
          ...
          {payload.map(({ value, category, color }, index) => (
            ...
            >
              <div className="flex items-center space-x-2">
                ...
                />
                <p className={cx("text-right whitespace-nowrap", "text-gray-700")}>
                  {category}
                </p>
              </div>
              <p
