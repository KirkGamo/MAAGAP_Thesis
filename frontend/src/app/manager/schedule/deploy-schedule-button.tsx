...
export function DeployScheduleButton() {
  ...
  const confirmCaption = pendingPreview
  ...
  return (
    <div className="flex flex-col items-end gap-1.5">
      {pendingPreview ? (
        <div className="flex max-w-72 flex-col items-end gap-1.5 rounded-md border border-orange-200 bg-orange-50 p-2">
          <p className="text-right text-[11px] text-orange-700">{confirmCaption}</p>
